...
9.18 1024的项目一直没有更新，抱歉让大家等待了。因为我们陷入了开发的瓶颈。粉末版的1024多次配方改良，内部试用后，仍然存在溶解性不好的现象，杯子不好冲洗。原本为了解决吃饭麻烦而设计的产品，反而增加了洗杯子这个繁琐的流程。这个原材料的属性有极大的关联，一般植物性蛋白溶解性都不是很好。
那么大家可能会问：就开发一个和soylent一样的液体版本咋样？很遗憾的告诉各位，大天朝有个东西叫法规，没法往液体中添加那么多的营养元素。
关于固体的版本，我们也做过多次的尝试，做成手指饼干的形状，但它的口味并未得到公司内部工程师们的认可，而且运输过程中会出现破损的现象，也就是大家可能收到一堆断手断脚的未知物。。。。
作为研发者，不希望产品以半成品的形态呈现给大家，觉得很对不起一直支持期待它的用户。
因此，我们的1024项目暂时停止了，跪求各位的原谅＝＝
如果大家有什么好的反馈和意见，可直接发邮件给我：wangyiwen@boohee.com
